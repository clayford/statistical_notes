...
- [mixed-effect proportional odds model](simulate_analysis.html) (2022-02-25)       
An example of a mixed-effect proportional odds model using simulated data and the `clmm()` function from the {ordinal} package.
